...
namespace Cindy_Restaurant.Forms
{
    public partial class frmOrder : Form
    {
        ...
        void printDoc_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            grafic.DrawString("\tPlatea21 Restaurant", new Font("Courer New", 14), new SolidBrush(Color.Black), StartX, StartY);
            ...
            grafic.DrawString("Recibo", new Font("Courer New", 10), new SolidBrush(Color.Black), StartX, StartY + 40);
            grafic.DrawString("\t\t" + kot.PadRight(30), new Font("Courer New", 10), new SolidBrush(Color.Black), StartX, StartY + 40);

            grafic.DrawString("\t\t\tDia: " + lblgetDateTime.Text, new Font("Courer New", 10), new SolidBrush(Color.Black), StartX, StartY + 40);


            grafic.DrawString("Mesa#: ", new Font("Courer New", 10), new SolidBrush(Color.Black), StartX, StartY + (offSet + 20));
            ...
            grafic.DrawString("Servidor #: ", new Font("Courer New", 10), new SolidBrush(Color.Black), StartX, StartY + (offSet + 40));
            grafic.DrawString("\t\t" + lblwaiterName.Text, new Font("Courer New", 10), new SolidBrush(Color.Black), StartX, StartY + (offSet + 40));

            grafic.DrawString("Invitado ", new Font("Courer New", 10), new SolidBrush(Color.Black), StartX, StartY + (offSet + 60));
            ...
            grafic.DrawString("Producto ", new Font("Courer New", 10), new SolidBrush(Color.Black), StartX, StartY + (offSet + 100));
            grafic.DrawString("\t\t\t  Cantidad", new Font("Courer New", 10), new SolidBrush(Color.Black), StartX, StartY + (offSet + 100));
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("The selected Item has been freeze" + Environment.NewLine + "Reason: " + reason, "Bring To Notice - Platea21 Restaurant", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        {
            if (lblOrderDescription.Text == "Comer aqui".Trim() || lblOrderDescription.Text == "Para llevar".Trim()) { 
                   placeOrder();
               
            }
            else if (lblOrderDescription.Text == "Sin cargo".Trim()) {
        ...
        private void btnModify_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                       ...
                       itemName = listView1.FocusedItem.SubItems[2].Text;
                        ...
                        {
                            MessageBox.Show("Please click to select item", "Help - Platea21 Restaurant", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                            return;
        ...
        private void btnComplimentary_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception)
            {
                ...
                MessageBox.Show("Error: " + "Please click to compliment your order", "Throwing Exception - Platea21 Restaurant", MessageBoxButtons.OK, MessageBoxIcon.Warning);
